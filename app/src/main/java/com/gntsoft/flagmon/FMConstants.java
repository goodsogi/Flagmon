...
public class FMConstants {
    ...
    public static final String KEY_PUSH_ENABLE = "pushEnabled";
    public static final String KEY_USER_EMAIL = "userEmail";
    public static final String KEY_USER_PASSWORD = "userPassword";
    public static final String KEY_USER_NAME = "userName";
    public static final String KEY_POLICY_TYPE = "policyType";
    public static final int POLICY_SERVICE = 0;
    public static final int POLICY_PRIVACY = 1;
    public static final int POLICY_LOCATION = 2;
    public static final String KEY_IMAGE_URL = "imageUrl";
    public static final String PREF_NAME = "flagmonPref";
